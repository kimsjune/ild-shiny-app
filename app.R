...
ui <- bslib::page_navbar(
  ...
  bslib::nav_panel(
    ...
    tags$div(class = "row",
            ...
            tags$div(class = "col-sm",
                     tags$h3("Scope"),
                     p("This app allows users to interactively visualize spatial transcriptomics data. Select any number of annotation-ILD subtype from the left bar, and hit run. Four output types are available: PCA, table, Volcano and Heatmap plots, each with a few customization options."),
                     tags$h3("Rationale"),
